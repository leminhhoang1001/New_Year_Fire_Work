...
function init() {
    ...
    appNodes.canvasContainer.style.backgroundImage = "url(pic/city_HCM2.png)";
    appNodes.canvasContainer.style.backgroundRepeat = "repeat-x";
    appNodes.canvasContainer.style.backgroundPosition = "bottom center";
    appNodes.canvasContainer.style.backgroundSize = "intial";
...
const currentSkyColor = { r: 3, g: 0, b: 15 };
const targetSkyColor = { r: 1, g: 0, b: 15 };
...
function colorSky(speed) {
    ...
    appNodes.canvasContainer.style.backgroundColor = `rgb(${currentSkyColor.r | 3}, ${currentSkyColor.g | 0}, ${currentSkyColor.b | 15})`;
